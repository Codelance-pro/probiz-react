            ...
            <div className="relative flex justify-center animate-bounce-in -mb-20 sm:-mb-32 lg:-mb-40">
              <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
                ...
                <div className="hidden lg:block absolute -left-60 xl:-left-34 top-20 w-full xl:w-60 lg:w-60 transform -rotate-[10deg]">
                  ...
                  <img src={frame1} alt="Probiz Logo" className="w-full h-full xl:w-full xl:h-full mb-2 " />
                </div>
                  ...
                  <img src={frame2} alt="Probiz Logo" className="w-full h-full xl:w-full xl:h-fullmb-2" />
                </div>
      ...
      <footer className="px-4 rounded-b-3xl  sm:px-6 py-8 sm:py-12 border-t border-border/20 bg-gradient-to-r from-purple-700 via-purple-800 to-indigo-900">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-muted-foreground text-white mb-4 sm:mb-6 px-4">Join thousands of teams already using Probiz to boost their productivity.</p>
            <Button size="lg" className="bg-[#00143e] hover:opacity-90 rounded-full px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg flex items-center justify-center mx-auto">
              {/* <Download className="w-4 sm:w-5 h-4 sm:h-5 mr-2" /> */}
              Book a Demo
            </Button>
          </div>
