...
const SalesConnect = () => {
  ...
  const features = [
    {
      ...
      description: "Process orders instantly with automated workflows and real-time status updates for seamless operations.",
    ...
    },
    {
      ...
      description: "Monitor stock levels and automate reorder processes with intelligent forecasting and alerts.",
    ...
    },
    {
      ...
      description: "Gain valuable insights into sales trends and revenue with our powerful reporting tools.",
    ...
    },
    {
      ...
      description: "Design and track incentive programs to motivate your sales team effectively.",
    ...
    },
    {
      ...
      description: "Connect stakeholders with integrated messaging and notification systems.",
    ...
    },
    {
      ...
      description: "Optimize delivery routes and reduce operational costs with AI-powered planning.",
  ...
  const stats = [
    { number: "500+", label: "Active Dealers", icon: <Users className="w-6 h-6" /> },
  ...
  const faqs = [
    {
      ...
      answer: "Sales Connect offers seamless integration with popular CRM, ERP, and accounting systems through our comprehensive API. We support real-time data synchronization and provide dedicated support during the integration process."
    },
    {
      question: "What kind of reporting and analytics are available?",
      answer: "Our platform provides comprehensive analytics including sales performance metrics, inventory turnover rates, dealer performance scorecards, territory analysis, and custom reporting dashboards. All reports can be scheduled and automated."
    },
    {
      question: "Is there mobile support for field sales teams?",
      answer: "Yes, Sales Connect includes a fully-featured mobile app for iOS and Android. Field sales teams can access real-time inventory, process orders, communicate with dealers, and update customer information on the go."
    },
    {
      question: "How secure is the data on Sales Connect?",
      answer: "We implement enterprise-grade security with 256-bit SSL encryption, regular security audits, role-based access controls, and SOC 2 compliance. Your data is backed up regularly and stored in secure, geographically distributed data centers."
    },
    {
      question: "What support is available during implementation?",
      answer: "We provide comprehensive onboarding including dedicated account managers, technical support team, training sessions for your staff, and ongoing support. Implementation typically takes 2-4 weeks depending on complexity."
    },
    {
      question: "Can the system handle multiple currencies and regions?",
      answer: "Yes, Sales Connect supports multi-currency operations, regional pricing strategies, localized tax calculations, and can be configured for different time zones and business rules across various markets."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Streamline operations and boost revenue with our powerful suite of integrated tools
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8 text-lg">
                Gain valuable insights into sales trends and revenue with our powerful reporting tools. Make data-driven decisions that drive growth and optimize performance.
              </p>
              <div className="space-y-6">
                {[
                  { icon: <Monitor />, title: 'Custom Dashboards', desc: 'Create personalized views of your key metrics' },
                  { icon: <BarChart3 />, title: 'Predictive Analytics', desc: 'Forecast trends and anticipate market changes' },
                  { icon: <Target />, title: 'Performance Metrics', desc: 'Track KPIs and measure team effectiveness' },
                  { icon: <Globe />, title: 'Revenue Tracking', desc: 'Monitor revenue streams across all channels' }
                ].map((item, index) => (
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of businesses already using Sales Connect to streamline operations and boost revenue. Start your free trial today.
          </p>
