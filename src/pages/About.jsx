        ...
        <div className="min-h-screen bg-white px-4 sm:px-6">
            ...
            <section className="relative bg-gradient-to-b from-[#dbeafe] via-[#eef2ff] to-[#fff1f2] min-h-screen flex items-center overflow-hidden ">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute bottom-20 right-20 w-80 h-80 bg-[#f0e6ff]/30 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
                    <div className="absolute top-1/2 left-1/4 w-40 h-40 bg-[#e6d9ff]/50 rounded-full animate-pulse" style={{ animationDelay: '4s' }}></div>
                </div>
                        ...
                        <div className="text-white space-y-8">
                            <div className="animate-slide-in-left">
                                <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 mt-2">
                                    <span className="text-sm font-semibold text-black">About Probiz Connect</span>
                                </div>
                            ...
                            <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12 transform hover:scale-105 transition-all duration-500">
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-gray-600 leading-relaxed">
                                        To know more about our product, reach out to us today, and we'll be happy to
                                        demonstrate the product features.
                                    </p>
                                </div>

                                <div className="space-y-4">
                                    <Button className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-xl py-6 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                                        Book a Demo
                                    </Button>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        {aboutData.map((item, index) => (
                            <div
                                ...
                                data-animate
                                id={`about-card-${index}`}
                                className={`group transition-all duration-700 ${isVisible[`about-card-${index}`]
            ...
            <section className="py-20 bg-gradient-to-r from-purple-700 via-purple-800 to-indigo-900 relative ">
                ...
                <div className="absolute inset-0 opacity-10">
                    ...
                    <div className="absolute bottom-10 right-10 w-60 h-60 bg-pink-300 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
                </div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        <div className={`transition-all duration-1000 ${isVisible['cta-section'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                            ...
                            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                                Join thousands of teams already using Probiz to boost their productivity.
                            </p>
                    ...
                    <div className={`text-center text-purple-200 mt-16 transition-all duration-1000 ${isVisible['cta-section'] ? 'opacity-100' : 'opacity-0'
