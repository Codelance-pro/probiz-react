  ...
  const features = [
    {
      ...
      description: "Plan sales routes efficiently with intelligent navigation features, saving time and fuel costs while maximizing customer visits.",
      image: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=400&h=300&fit=crop&crop=entropy",
      gradient: "from-blue-500 to-cyan-500",
      benefits: ["Smart route planning", "Fuel cost savings", "Time optimization"]
    },
    {
      icon: <Database className="w-8 h-8" />,
      title: "Mobile Customer Access",
      description: "Access crucial customer information on the go. Your sales team can view customer history, preferences, and data anytime, anywhere.",
      image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&h=300&fit=crop&crop=entropy",
      gradient: "from-green-500 to-emerald-500",
      benefits: ["Real-time data access", "Customer insights", "Mobile-first design"]
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Performance Tracking",
      description: "Monitor individual and team performance with comprehensive analytics and KPI tracking for continuous improvement.",
    ...
    },
    {
      ...
      description: "Comprehensive mobile application equipped with all essential sales tools for field representatives to excel in their roles.",
    ...
    },
    {
      ...
      description: "Streamlined communication channels between field staff, management, and support teams for seamless coordination.",
    ...
    },
    {
      ...
      description: "Comprehensive solution to empower field sales employees with tools, training, and technology for exceptional performance.",
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=300&fit=crop&crop=entropy",
      gradient: "from-teal-500 to-cyan-500",
      benefits: ["Skill development", "Performance incentives", "Career growth"]
    }
  ];

  const stats = [
    { number: "85%", label: "Productivity Boost", icon: <TrendingUp className="w-6 h-6" />, color: "text-green-600" },
    { number: "40%", label: "Route Efficiency", icon: <Route className="w-6 h-6" />, color: "text-blue-600" },
    { number: "95%", label: "Employee Satisfaction", icon: <UserCheck className="w-6 h-6" />, color: "text-purple-600" },
    { number: "24/7", label: "Mobile Support", icon: <Headphones className="w-6 h-6" />, color: "text-orange-600" }
  ];

  const empowermentAreas = [
    {
      title: "Frontline Brand Representatives",
      description: "Recognize employees as the critical frontline representatives driving revenue and customer relationships",
      icon: <Users className="w-12 h-12" />
    },
    {
      title: "Technology Empowerment",
      description: "Equip your team with cutting-edge tools and technology to excel in their field sales roles",
      icon: <Smartphone className="w-12 h-12" />
    },
    {
      title: "Revenue Generation Focus",
      description: "Drive consistent revenue growth through empowered field sales teams and optimized processes",
  ...
  const faqs = [
    {
      ...
      answer: "Our mobile app provides comprehensive field sales tools including customer management, order processing, inventory access, route optimization, and real-time communication. It works offline and syncs data when connected, ensuring your team is always productive."
    },
    {
      question: "What kind of route optimization features are available?",
      answer: "The intelligent route optimization uses GPS and traffic data to plan the most efficient routes, considering factors like customer priority, appointment times, traffic conditions, and fuel costs. This can reduce travel time by up to 40% and significantly cut fuel expenses."
    },
    {
      question: "How does customer data access work on mobile devices?",
      answer: "Sales representatives can access complete customer profiles, purchase history, preferences, communication logs, and pending orders directly on their mobile devices. The data is secured with enterprise-grade encryption and automatically syncs across all platforms."
    },
    {
      question: "What performance tracking metrics are available?",
      answer: "The system tracks various KPIs including sales targets, conversion rates, customer visits, order values, territory coverage, and individual performance metrics. Managers get real-time dashboards while field staff receive personalized performance insights."
    },
    {
      question: "Is training provided for the employee empowerment tools?",
      answer: "Yes, we provide comprehensive training programs including onboarding sessions, video tutorials, user manuals, and ongoing support. Our training covers all aspects of the platform to ensure maximum adoption and effectiveness."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              Empower Your
              <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 bg-clip-text text-transparent"> Sales Team </span>
              to Excel
            </h1>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-xl border hidden lg:block">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">Empowered</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transform your sales organization by recognizing and empowering your frontline representatives
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {empowermentAreas.map((area, index) => (
              ...
              >
                <div className={`w-24 h-24 bg-gradient-to-r from-indigo-100 to-purple-100 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:shadow-lg transition-all duration-300 ${animatedCards[`area-${index}`] ? 'animate-pulse' : ''}`}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything your field sales team needs to drive revenue and build lasting customer relationships
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                {[
                  { icon: <Navigation />, title: 'Smart Navigation', desc: 'GPS-powered route planning with real-time traffic' },
                  { icon: <Clock />, title: 'Time Savings', desc: 'Reduce travel time by up to 40% with optimized routes' },
                  { icon: <Target />, title: 'Customer Prioritization', desc: 'Intelligent scheduling based on customer importance' },
                  { icon: <Zap />, title: 'Fuel Efficiency', desc: 'Minimize fuel costs through optimized routing' }
                ].map((item, index) => (
                  <div key={index} className="flex items-start space-x-4 group">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1 group-hover:text-indigo-600 transition-colors">{item.title}</h4>
