        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {partnerTypes.map((type, index) => (
              <div
                key={index}
                className={`text-center group hover:transform hover:scale-105 transition-all duration-500 p-8 rounded-3xl ${
                  currentPartner === index ? 'bg-gradient-to-br from-blue-50 to-purple-50 ring-4 ring-blue-200' : 'bg-gray-50'
                }`}
